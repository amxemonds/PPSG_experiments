...
if __name__ == "__main__":
    ...
    for obj in range(objCounts):
        ...
        for distance in range(3,7):
            information.append([descIds[stim],distance/7*3,2])
            information.append([descIds[stim+1],distance/7*3,3])
            information.append([descIds[stim+2],distance/7*3,4])
            information.append([descIds[stim+3],distance/7*3,5])
            stim += 4
